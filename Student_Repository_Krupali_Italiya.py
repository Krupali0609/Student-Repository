...
class University:
    ...
    def _get_majors(self, path):
        ...
        try:
            maj_info: Iterator[Tuple[str]] = file_reader(path, 3, sep='\t', header=True)
    ...
    def student_table(self):
        ...
        Table:PrettyTable = PrettyTable(field_names=Student.prettytable_header)
        a=list()
    ...
    def instructor_table(self):
        ...
        Table:PrettyTable = PrettyTable(field_names=Instructor.prettytable_header2)
...
class Student:
    """ Student class """
    prettytable_header = ["CWID", "Name", "Major", "Completed Courses", "Remaining Required", "Remaining Electives","GPA"]
    ...
    def ptable_row(self):
        ...
        major, passed, rem_required, rem_electives = self._major.remaining_courses(self._courses)
